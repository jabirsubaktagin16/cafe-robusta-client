...
export default function Footer() {
  return (
    <footer
      style={{
        backgroundImage: `url("./footer-texture.jpg")`,
    ...
    >
      <div className="grid grid-cols-1 gap-8 px-20 py-10 md:grid-cols-3">
        <div>
          <div className="text-white text-start ">
            <h4 className="text-2xl oswald-font uppercase font-bold">
              Contact Us
            </h4>
            <p className="mt-8">
              18 West Buffalo St
              <br /> Warsaw, New York 14569
              <br /> Phone: 1-585-786-8181
            </p>
          </div>
        </div>
        <div>
          <div>
            <h4 className="text-2xl text-start text-white oswald-font uppercase font-bold">
              Opening Hours
            </h4>
      ...
      <div className="px-20 py-6 bg-base-200 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-300 sm:text-center">
          © 2023 <a href="https://flowbite.com/">Cafe Robusta™</a>. All Rights
          Reserved.
        </span>
